            ...
            <div className='background'>
                ...
                <div className='container-fluid'>
                    <div className="mx-auto text-center p-2">
                        <img src={theme.float4} alt="Float" className='float' />
                    </div>
                </div>
                ...
                <footer>
                    ...
                    <div className='calltoaction'>
                        ...
                        <p className='subtitle'>I’m always open to discussing design and dev work.</p>
                        <br />
                        <a href="mailto:sarmiento.mkv@gmail.com" target='_blank' rel="noreferrer" className='button footer-button'>Email Me</a>
                    </div>

                    <div className="row">
                            <div className='col text-start'><small>Crafted by MK Vann S.</small></div>
                            <div className='col'><b onClick={scrollToTop}><i className="bi bi-caret-up-fill text-center"></i></b></div>
                            <div className='col text-end'><small>© Copyright 2023</small></div>
                        </div>
                </footer>
